...
$("select[id^=pay]:not(:disabled) option:selected").each(function(){if($(this).text().toLowerCase().indexOf("предоплата")>-1){isPREPAY=true}});if(isPREPAY){$("#ztojzlBzmxFh").show()}else{$("#ztojzlBzmxFh").hide()}}function
QGChJGA(a){return a.replace(/^\s+/,"")}
