					...
					<div id="tab-common-<?php echo $module_row; ?>">
						<table class="form">
							...
							<tr>
								...
								<td><input type="text" name="jv_products_in_m_module[<?php echo $module_row; ?>][adding_class_to_box]" value="<?php echo isset($module['adding_class_to_box']) ? $module['adding_class_to_box'] : ''; ?>" size="60" />
								</td>							
							</tr>
							
							<tr>
								<td><?php echo $entry_adding_id_to_box; ?></td>
								<td><input type="text" name="jv_products_in_m_module[<?php echo $module_row; ?>][adding_id_to_box]" value="<?php echo isset($module['adding_id_to_box']) ? $module['adding_id_to_box'] : '';   ?>" size="60" />
								</td>							
							</tr>
