...
<?php @$this->load->language('tool/yml'); ?>
	    <?php if (@$this->language->get('text_ymlmenu') != NULL) { ?>
            <li><a href="<?php echo (((HTTPS_SERVER) ? HTTPS_SERVER : HTTP_SERVER) . 'index.php?route=tool/yml&token=' . $this->session->data['token']); ?>"><?php echo $this->language->get('text_ymlmenu'); ?></a></li>
	    <?php } ?>
        </ul>
      </li>
